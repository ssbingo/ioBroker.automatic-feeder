...
const MESSAGES = {
	...
	// {minutes} is replaced with the configured lead time (announceLeadMin).
	announce: {
		en: 'Attention! The next feeding starts in {minutes} minutes',
		de: 'Achtung! Die nächste Fütterung beginnt in {minutes} Minuten',
		ru: 'Внимание! Следующее кормление начнётся через {minutes} минут',
		pt: 'Atenção! A próxima alimentação começa em {minutes} minutos',
		nl: 'Let op! De volgende voedering begint over {minutes} minuten',
		fr: 'Attention ! La prochaine distribution commence dans {minutes} minutes',
		it: 'Attenzione! La prossima alimentazione inizia tra {minutes} minuti',
		es: '¡Atención! La próxima alimentación comienza en {minutes} minutos',
		pl: 'Uwaga! Następne karmienie rozpocznie się za {minutes} minut',
		uk: 'Увага! Наступне годування почнеться через {minutes} хвилин',
		'zh-cn': '注意！下一次投喂将在 {minutes} 分钟后开始',
	},
	feedSuccess: {
