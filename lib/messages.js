...
const MESSAGES = {
	...
	// Placeholder texts for now (identical in every language); the final wording
	// is provided later. A {minutes} token is available for a future "in X min" text.
	announce: {
		en: 'Achtung! Fütterung',
		de: 'Achtung! Fütterung',
		ru: 'Achtung! Fütterung',
		pt: 'Achtung! Fütterung',
		nl: 'Achtung! Fütterung',
		fr: 'Achtung! Fütterung',
		it: 'Achtung! Fütterung',
		es: 'Achtung! Fütterung',
		pl: 'Achtung! Fütterung',
		uk: 'Achtung! Fütterung',
		'zh-cn': 'Achtung! Fütterung',
	},
	feedSuccess: {
