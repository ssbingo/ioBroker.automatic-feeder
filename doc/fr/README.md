...
> **Remarque :** tous les points de données horodatés sont affichés dans le **fuseau horaire local du système** (format `JJ.MM.AAAA HH:MM:SS`, p. ex. `01.07.2026 16:20:00`).
